...
先算一笔账：听力满分 248.5 分，正好占 710 分的 35%，这个比重在四六级所有模块里是最高的。

![六级各模块分值占比（笔记配图）](/images/posts/cet6-exam-prep/07.webp)听力拿不到及格分 149，别的模块就得拼命往上找补；听力能稳在 149 往上走，过级就稳了一半。这也是为什么我一直强调：听力直接决定了你六级能不能顺利通过。
...
重要的事情说三遍。觉得我胡扯的同学，可以先关掉页面冷静一下——你可以去看看其他人的技巧，我的内容不一定适合你。但我还是建议你看完再判断。
...
所以在有限的时间里，我们要学会"科学地预读"：拿到一个选项，有时间就通读一遍，没时间直接跳过，进入标记环节。**标记的内容只有三类核心：否定词、动宾（动词+名词）、系表（动词+形容词）。** 翻译成人话就是：否定词必划，动词带着它的名词或形容词划。
...
"视听一致"和"同义替换"是四六级听力正确答案的两大原则，很多网课老师都讲过，已经不是公开的秘密了。但知道和会用是两回事，不清楚的同学正好借此了解一下，对通过六级还是非常有帮助的。
...
原文是：It generally covers a wide variety of medical services and you are often given a list of doctors in the area where you will travel who may even speak your native language. The drawback might be that you may not get your money back immediately.
...
同义替换对学英语的同学来说太熟悉了，阅读里有、听力里有、作文里也有。可以说，**英语考试的最高境界就是同义替换**。所以有老师常开玩笑说：同义替换是一种能力，不是一种技巧。英语里的一切都能被替换，单词、短语、句子，统统可以。平时练习的时候，就要刻意去锻炼这种能力。
...
原文是：We should reject stereotypes, because they force all people in a group into the same simple pattern. They fail to account for individual differences（无法解释个体差异）, and the wide range of characteristics among members of any group.
...
接下来才是真正提分的基础——修炼听力内功。你要想每次考试都拿高分，功底才是最稳妥的武器。技巧有时候挺苍白的，它保证不了你通过。很多同学觉得"听力考试就是听得懂"，这其实只说对了一半。我当了这么久老师可以负责任地说：**即使是最优秀的同学，也很难很难很难从头到尾完全听懂**（凤毛麟角）。所以请记住这个公式：
...
**② 单词的发音和语音现象。** 很多词你认识，但听力里带上了连读、略音、爆破，你就听不出来了。这一块不补，词汇量再大也白搭。

**③ 大量的练习。** 没有量的积累，前两个要素都落不了地。
...
作文是我备考时整理的重点，我手上有两套好用的模板，一套偏"社会现象议论型"，一套是"主题型万能模板"，提前背熟，考场上直接往里填内容就行。我建议考前把 1~2 套模板背到能默写的程度，考试时只替换主题词和例子，剩下的交给肌肉记忆。作文时间很紧，别指望临场创作。

**第一套：社会现象议论型模板。** 结构是：开头引出话题（社会现象+你的态度）→ 中间论证观点（讲道理+举实例）→ 结尾呼吁措施（媒体宣传+个人行动）。这套模板逻辑很顺，什么"物质与精神""品质与美德"类的话题都能套。完整的模板文本是这样的：
...
下面一个一个来。内容可能有点基础，是想照顾基础薄弱的同学；英语好的大佬可以直接往后跳。翻译这一部分我拆成两大部分：**第一大部分是六级翻译必备技巧，第二大部分是六级翻译方法**，两个部分都非常非常非常重要，请大家务必一口气全部看完！

### 1. 修饰后置

这是我最看重的一个技巧，分为三个内容：**介词短语、定语从句、插入语同位语**。

![修饰后置的三个内容（笔记配图）](/images/posts/cet6-exam-prep/05.webp)重点是前两个，插入语同位语最近几年考得少了，但以防万一还是要讲。以上这三点都是六级翻译中我们一定会遇到的三种句子，大家一定要好好感受。这三种句子，你随便翻几篇历年真题译文，几乎句句都能对上号。
...
把语序编上号你就更清楚了：1 是"过中秋节的"（修饰习俗），2 是"习俗"（主语），3 是"于唐代早期"（时间状语），4 是"在中国各地"（地点状语），5 是"开始流行"（谓语）。

![语序编号：从 12345 到 21543（笔记配图）](/images/posts/cet6-exam-prep/04.webp)中文的正常顺序是 1、2、3、4、5，修饰后置之后就变成了 2、1、5、4、3：先写主语"习俗"，再挂"过中秋节的"，然后写谓语"开始流行"，时间和地点放到后面。**这就是修饰后置：先调语序，再解决单词问题。**

语序搞定了，再去解决单词：

- "过"中秋节：很多同学不知道"过"怎么翻，那就转换思路——**意思相同即可！**"过"不就是时间上的一种度过吗？spend 就可以；官方答案给的 celebrate（庆祝中秋节）当然更准确。**spend 和 celebrate 都给满分。**
...
![语序组合示例（笔记配图）](/images/posts/cet6-exam-prep/06.webp)
...
好，第一部分、也是我认为最重要的**修饰后置**部分就结束了，大家一定要好好感受，做好练习。接下来进入第二部分：多动句。

### 2. 多动句

所谓多动句，就是一个句子里出现多个动词，这种类型的句子在近两年的考试中特别特别常见，大家务必要掌握好。

![谓语与非谓语的区分（笔记配图）](/images/posts/cet6-exam-prep/02.webp)汉语里没有谓语动词和非谓语动词之分，英语里却有严格区分：**一个句子有且只有一个谓语动词**。这是英语的铁律，就像家里只能有一个当家的。搞清楚这一点，处理起来就有方向了。
...
以上是多动句的内容，后面我会以近两年的真题为例做一个整体的翻译，你会发现我所说的技巧在题目中多次出现。

### 3. 无主句

无主句就是没有主语的句子，在汉语里特别常见。想想那首《寻隐者不遇》：松下问童子——谁问？言师采药去——谁说？只在此山中——谁在？云深不知处——谁不知？每一句都没有主语，但中国人读起来毫无障碍。

![无主句示例（笔记配图）](/images/posts/cet6-exam-prep/03.webp)

英语就不行了：**句子中必须要有主语**。所以我们的处理方式一般是——**变被动**，这也是我最推荐的方式。

![无主句的处理方式：变被动（笔记配图）](/images/posts/cet6-exam-prep/01.webp)非人主语的情况我后面单独说。记住这个规律：拿到一个句子发现不好翻，通常就是缺主语，第一反应就是被动句。为什么最推荐变被动？因为被动句既不用纠结主语是谁，又符合英语的表达习惯，还天然规避了主谓一致的语法错误。
...
2. 定语从句（两个版本）：Peony is colorful and elegant, which symbolizes peace and prosperity. / Peony, which is colorful and elegant, symbolizes peace and prosperity.（从语法上讲，你把"艳丽高雅"处理成谓语，或把"象征"处理成谓语，都算对）
