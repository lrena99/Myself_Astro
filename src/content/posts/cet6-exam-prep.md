...
category: "学习"
draft: false
image: "/images/covers/wall-06.webp"
---

# 六级速成攻略：听力技巧、翻译方法一次讲透

四六级满分 710 分，听力一个模块就占了 35%，整整 248.5 分。这么说吧，听力就是六级路上最大的那只拦路虎，它直接决定了你到底能不能顺利过线。我身边考六级的朋友，复盘的时候十有八九会说同一句话：听力没听懂，心态直接崩了。
...
整篇笔记分成两大部分：**第一大部分是应试技巧，第二大部分是备考攻略**。技巧负责"救急"，功底负责"保命"，两样都要抓。技巧能帮你把已经有的水平最大化，但真正决定你听力上限的，永远是实打实的功底。

## 一、先摸摸六级的底细：听力到底怎么考？

六级听力一共 25 道题，分成三个小板块，各自的分量和脾气都完全不一样：

| 题型 | 题目数量 | 占比 | 每题分值 | 满分 |
| --- | --- | --- | --- | --- |
| 长对话 dialog（2 篇） | 8 道 | 8% | 7.1 分 | 56 分 |
| 短文 passage（2 篇） | 7 道 | 7% | 7.1 分 | 49 分 |
| 讲座 lecture（3 篇） | 10 道 | 20% | 14.2 分 | 142 分 |

看出来了吗？第三部分的**讲座 lecture 占比高得离谱**：20% 的占比，每题 14.2 分，一道题顶前面两道。换句话说：六级能不能过看听力，听力能不能过看讲座。哪怕你前面长对话、短文听得稀里哗啦，只要讲座部分能稳住，一切都还来得及。
...
但反过来想，这种形式也给了我们一个好处：**你不需要完全听懂**。你只需要选对选项、做对题目就够了。事实上，我教过那么多学员，几乎没有一个人能从头到尾完全听懂六级听力（特别优秀的除外）。既然大家都听不懂，比的就不是"全懂"，而是"谁更会抓重点"。而抓重点，靠的就是下面这些方法。

## 二、听力应试四技巧

先说在前面：六级听力的应试技巧是有限的，别指望技巧能救命。技巧给你之后，精力还是要放到后面的备考攻略上。只有不断练习、切实提升听力能力，才是最稳妥的路。

### 技巧 1：不要听题目，不要听题目，不要听题目！

重要的事情说三遍。觉得我胡扯的朋友，可以先关掉页面冷静一下——但我建议你看完再判断。

确实有极少数题目需要听懂题目才能做，比如四个选项 ABCD 全都被读到了，需要你从中确定唯一答案。但如果你把历年真题都刷一遍就会发现：25 道题里，这种"必须听题目"的题，**最多只有 1~2 道**。如果你的目标不是 650 分以上，前面也没有把握全对，这种题我建议你直接放了。
...
一是**前面的内容你记不住了**。六级听力材料太长，一篇文章至少出 3 道题，它考的已经不只是听力，还有记忆力——就算你听懂了，再把题目从头听一遍，等题目读完，前面的文章内容早就忘光了。二是**题目本身也听不懂或者毫无意义**。听力最常见的出题形式就是"What is the passage mainly about"这种，听懂了也等于没听。

所以我的铁律是：**文章一结束，答案立刻选出来**。没听到就拉倒，千万不要花时间冥思苦想。果断放弃纠结，马上开始预览下一题的选项。相信我，不听题目不会影响你的正确率，把听题目的时间省下来，全部花在预读选项上，这才是聪明人的做法。

### 技巧 2：科学预读选项（重点，拿笔记下来）

六级听力的选项有一个非常明显的特点：**特别长！** 而且里面还混着很多不认识的单词。很多同学根本没时间通读选项，标记的时候又觉得什么都想划，划了半天划不到终点。

所以在有限的时间里，我们要学会"科学地预读"：有时间就通读一遍，没时间直接跳过，进入标记环节。**标记的内容只有三类核心：否定词、动宾（动词+名词）、系表（动词+形容词）。** 翻译成人话就是：否定词必划，动词带着它的名词或形容词划。

拿 2011 年六级听力的一道真题举个例，大家先自己试着标一下，再对照我的答案：
...
预读选项的方法非常重要，考前一定要练熟，它是后面所有技巧的地基。

### 技巧 3：视听一致（所听即所得）——正确答案原则一

"视听一致"和"同义替换"是四六级听力正确答案的两大原则，很多网课老师都讲过，不算什么秘密，但知道和会用是两回事。
...
你看，lacks、stability、printed word 全都在原文里原封不动地出现了，一个同义替换都没有——这就是视听一致最简单粗暴的形式，**完全不需要动脑子**。但有意思的是，很多同学偏偏不敢选：因为高中英语的出题套路是"在原文处设陷阱"，大家都被坑怕了。殊不知四六级因为出题形式本身就很难（跟托福基本一致，不给题目只给选项），出卷人为了保证一定的基础正确率，会专门设置这种**送分题**。就算你全程没听懂，这种题也能做对。所以送分题必须拿到手，一个都不能丢。
...
这道题里，mixed feelings 是完完全全的视听一致；而 biological 和 natural 是同义替换。答案 C 就靠这两个点锁定。从这道题能看出三个规律：第一，视听一致的题目选项一般特别长、信息特别多，所以预读选项极其关键；第二，稍微有点难度的视听一致题，只在关键信息处给你提示，其他部分一概不提；第三，**视听一致+同义替换组合考察，是目前六级最最常见的题型**，占到一半以上，它有一定难度但不会太难，能筛掉一批人，又给有实力的人留了活路，所以出题人最爱出。想过六级听力，这种组合题必须攻克。

但视听一致最难的形态，长这样（这道题当年正确率只有 15%）：
...
原文大意是：保险一般覆盖很多医疗服务，你会拿到一份目的地医生的名单，有的医生甚至会说你的母语；但缺点可能是，你的钱不能马上拿回来。

答案是 A，但有 70% 的同学选了 C。为什么？因为 C 选项从 doctors 开始到结尾，跟原文几乎一字不差，而 A 选项只有 not 和 get back money 在原文中出现。看起来 C 读到的细节多得多，但别忘了我们预读时划的是什么——**动宾部分**。C 选项虽然划出来一长串，但真正的宾语只有 doctors，后面全是 doctors 的定语从句，优先级很低；而 A 选项虽然短，但否定词和动宾部分全部读到了。所以按选项优先级，毫不犹豫选 A。

记住这个结论：**听到原文里有选项一模一样的单词，先别激动，要确认是不是我们预读时标记的部分；如果标记的部分全部读到了，它的优先级才是最高的。不是谁读到的单词多，谁就是答案。** 至于那种更难的题，数量很少，属于拉开差距的题目，需要真功夫——听力功底这东西，没有 3~5 个月的辛勤付出根本提不上去，我们要做的就是在能力范围内，做对尽量多的题目。

### 技巧 4：同义替换——正确答案原则二

同义替换对学英语的同学来说太熟悉了，阅读里有、听力里有、作文里也有。可以说，**英语考试的最高境界就是同义替换**。所以有老师常开玩笑说：同义替换是一种能力，不是一种技巧。英语里的一切都能被替换，单词、短语、句子，统统可以。
...
原文说，我们应该拒绝刻板印象，因为它们把一群人强行塞进同一个简单模式里，无法解释个体差异。答案是 D：刻板印象阻止了我们对个体差异的理解。这里 hinder 对应原文的 fail to，perception 对应原文的 account for——你不仅要听懂原文，还要知道原文的哪个词是对选项中哪个词的同义替换，难度非常大。**这种纯同义替换题在六级听力里占到 20%**，比重不小，绝大多数同学碰到这种题基本就是抓瞎。

不过别灰心，六级里最多的还是"视听一致+同义替换"的组合题：一部分原样出现，一部分考替换。这种题有难度但没那么吓人，只要你提升听力内功、再学点技巧，正确率一定能上来。而纯同义替换的功底，只能靠平时刻意练习，没有任何捷径。

## 三、听力功底五步训练法（备考攻略）

接下来才是真正提分的基础——修炼听力内功。你要想每次考试都拿高分，功底才是最稳妥的武器。技巧有时候挺苍白的，它保证不了你通过。

很多同学觉得"听力考试就是听得懂"，这其实只说对了一半。我当了这么久老师可以负责任地说：**即使是最优秀的同学，也很难从头到尾完全听懂**（凤毛麟角）。所以请记住这个公式：

**听力高分 = 听力真实力 + 听力应试技巧**

所说的听力功底、听力内功，就是指这里的"真实力"。六级听力的技巧真的很有限，接下来的时间，请抓紧提升功底。想提升实力，关键盯住三个要素：**① 词汇量；② 单词的发音和语音现象；③ 大量的练习。**

具体怎么做？我整理了一套五步训练法，每一步都很朴素，但每一步都算数：
...
作文是我备考时整理的重点，我手上有两套好用的模板，一套偏"社会现象议论型"，一套是"主题型万能模板"，提前背熟，考场上直接往里填内容就行。

**第一套：社会现象议论型模板。** 结构是：开头引出话题（社会现象+你的态度）→ 中间论证观点（讲道理+举实例）→ 结尾呼吁措施（媒体宣传+个人行动）。这套模板逻辑很顺，什么"物质与精神""品质与美德"类的话题都能套。完整的模板文本是这样的（雷锋那个例子就是现成的论证素材，背下来就能用）：

> With the development of society and economy, people are becoming increasingly rich. However, a considerable number of people pay attention to the material things and ignore the beauty of the soul. Apparently, this is totally wrong. As a matter of fact, beauty of the soul is the essential beauty. From my perspective, beauty of the soul is to help others and make contributions to the society, which will not only be beneficial to growth and progress of young people but also contribute to construction of the society, which deserves our attention and emphasis. In order to justify the viewpoint that I have mentioned above, I cannot come up with a better illustration than the example of Lei Feng, a great warrior, who devoted his whole life to help others. As a consequence, he has the beauty of the soul and his life is extremely beautiful and meaningful.
>
...
我的建议是：考前把 1~2 套模板背到能默写的程度，考试时只替换主题词和例子，剩下的交给肌肉记忆。作文时间很紧，别指望临场创作。
...
下面一个一个来。内容可能有点基础，是想照顾基础薄弱的同学；英语好的大佬可以直接往后跳。

### 1. 修饰后置

这是我最看重的一个技巧，分为三个内容：**介词短语、定语从句、插入语同位语**。重点是前两个，插入语同位语最近几年考得少了，但以防万一还是要讲。

**① 介词短语**

英语和汉语在主干上语序其实完全一致，比如"我爱你"就是 I love you，一模一样。最大的区别在修饰：中文的修饰语爱往前面堆，英语的修饰语爱往后挂。

看一个六级翻译最典型的真题例句：

> 过中秋节的习俗于唐代早期在中国各地开始流行。（2014.6）

看到这句话，上来先不要想单词，有的同学开口就在纠结"过"怎么翻。写翻译之前，先解决语序问题。既然修饰后置，那么"过中秋节的"因为有"的"，习俗就要放在它的后面；"于唐代早期"是时间状语，"在中国各地"是地点状语，它俩都修饰动词"开始流行"。所以语序要从原来的 1、2、3、4、5，调成 2、1、5、4、3。语序搞定了，再去解决单词：

- "过"中秋节：很多同学不知道"过"怎么翻，那就转换思路——意思相同即可！"过"不就是时间上的度过吗？spend 就可以；官方答案给的 celebrate 当然更准确。**spend 和 celebrate 都给满分。**
- 中秋节：Mid-Autumn Festival 或 Chinese Lunar Festival，你写 Lunar Festival 都算对。
- 习俗：custom，想不起来写 tradition 也是满分。
- 唐代早期：Tang Dynasty 注意大写，early 是形容词，合起来 early Tang Dynasty。
- 在中国各地：写 everywhere 就没分了，throughout China 或 all over China 都满分。
- 开始流行：became popular、became fashionable、got popular、came into fashion，都满分。注意时态——一定是过去时！

组合起来就是：

> The tradition of celebrating/spending Mid-Autumn Festival became popular throughout China in the early Tang dynasty.

这里有两个细节提醒：第一，"中国各地"和"唐代早期"谁先谁后无所谓，大学阶段阅卷不抠这种细节；第二，in、on、at 分不清也没关系，你把 in 换成 at 我都不一定看得到，只要别作死把 in 换成 along 就行。**这句话的考点就是语序**，语序对了，小事不刁难你。但语法错误照样扣分，比如写成一般现在时，肯定扣。

顺便说下**专有名词**的处理：有的题会给注释，有的不给。只要没给注释，就说明这是考察点之一，比如"中秋节"是你初中就学过的词，写不出来就会扣分。但像"港珠澳大桥"这种词，阅卷是非常仁慈的，你怎么写都行，只要大致表达出那个意思；而且你写不出来，别人大概率也写不出来，标准答案很少有同学能写一样。那我们在哪个维度上狠狠扣分？就是修饰后置！因为它完美体现你的英语功底。

再来一个劝退级别的真题：

> 另一个则是乡村生活的种种乐趣，画有渔夫在湖上打渔，农夫在山上砍柴采药，或是书生坐在松树下吟诗作画。（2014.12）

还是一样，先调语序：先写"种种乐趣"，再挂"乡村生活的"；先写"渔夫打渔"，再挂"在湖上"；先写"农夫砍柴采药"，再挂"在山上"；先写"书生吟诗作画"，再挂"在松树下"。语序定完再想单词：

- 种种乐趣：various recreations of rural life，recreations 写不来，写 interests 也没问题。
- 渔夫打渔：fishermen fish on the lake——注意 fish 本身就能当动词用，就是"打渔"。
- 砍柴采药：farmers cut firewood or collect herbs on the hills。firewood 不会写写 wood 也给分；"采"想不起来 collect，写 pick up 也给分。但 herb 不会写写 medicine 要扣一点分，因为 medicine 一般指加工过的胶囊药品，你在山上可采不到那种药。
- 书生吟诗作画：scholars 不会写，写 students 也酌情给分；"吟诗"可以写 sing poems，官方答案是 compose poems（compose 是创作）；画画就是 paint；"坐在松树下"直接写 under pine trees 或 sitting under pine trees 都给分。
...
写完一定要检查语法：三单、谓语动词唯一！如果你这里没写冒号而写了逗号，那后面的谓语动词就得乖乖改成非谓语动词，不然一个句子就出现好几个谓语了。
...
土豪直接用拼音 Tuhao 就行。佃户是 tenant（大部分同学写不出来，不会就写 farmers，给分），仆人是 servant，不会写就 pass——个别单词实在不会就跳过，会扣一点分，但主要看整体句式，单个别单词不影响大局。欺压的官方答案是 oppress，想不起来就转换思路，欺压就是欺负，用 bully。指，可以用 mean，也可以用 refer to（注意三单）。花钱如流水，说白了就是"花钱没有节制"，spend money without control；实在想不起来，写"花很多很多钱"也酌情给分。炫耀是 show off，品位是 taste。组合起来：
...
注意一个坑：**result in、cause 这类表达后面不能直接跟句子**，要接句子必须写成 result in the fact that 这种形式。

再看一个：

> 中国人自古以来就在中秋时节庆祝丰收，这与北美地区庆祝感恩节的习俗十分相似。（2013.12）

前半句有明显的修饰后置要处理，后半句开头又有"这"指代前文，直接想到 which：

> Since ancient times, the Chinese people usually celebrate harvest in the Mid-Autumn, which is similar to the custom of celebrating Thanksgiving in the North America.

注意"自古以来"放在句中不好处理，就把它提到句首——以后遇到时间、地点状语都可以提前拉到句首，减少它对整个句子结构的干扰。

**③ 插入语同位语**

这个考点近几年考得很少，但简单说两句以防万一。同位语的作用是解释说明名词，插入语是它的一种形式。**以后只要六级翻译开头出现名词解释，比如"xx 是 xx"这样的说明内容，就立刻想到用插入语**，能把复杂的多动词结构瞬间简化。

看例句：

> 旅游业是最近二十年来在世界各地迅速发展的一个行业，现在正引起中国公众越来越大的注意。

正常翻译是 Tourism is a fast developing industry for the last two decades all over the world, which now draws more and more attention of Chinese public——能翻，但有难度。用了插入语就清爽多了：
...
> 世界贸易组织是成立于 1995 年 1 月 1 日的，目的是确保一个稳定的全球贸易经济环境。

正常版：The WTO was founded on January 1st, 1995, which aims to ensure a stable environment of trading and economy in the world.插入语版：

> The WTO, founded on January 1st, 1995, aims to ensure a stable environment of trading and economy in the world.

只需要考虑一个谓语动词，比正常翻译简便太多了。总结一句：只要出现解释说明某个名词的部分（一般出现在开头），立刻想到插入语和同位语。

### 2. 多动句

所谓多动句，就是一个句子里出现多个动词。汉语里没有谓语动词和非谓语动词之分，英语里却有严格区分：**一个句子有且只有一个谓语动词**。这是英语的铁律，就像家里只能有一个当家的。
...
这就是最典型的多动句，设定、减少、提高、改善、扩大，一堆动词。离主语"政府"最近的动词是"设定"，定为谓语，其他全部非谓语化：
...
两个细节：第一，出现"已"这样的字眼，要处理成完成时态；第二，多个 to do 并列，后面的 to 要省略。我能不能全写成 -ing 并列？可以，但会扣一点分数。

再看：

> 鉴于这一状况，政府近来采取了一系列的措施来防止房价过快增长，包括提高利率及增加房产税等。（2013.12）

跟上一题一模一样：离主语最近的动词是"采取"，做谓语；后面的动词全部非谓语化：
...
无主句就是没有主语的句子，在汉语里特别常见。想想那首《寻隐者不遇》：松下问童子——谁问？言师采药去——谁说？只在此山中——谁在？每一句都没有主语，但中国人读起来毫无障碍。

英语就不行了：**句子中必须要有主语**。所以我们的处理方式一般是——**变被动**，这也是我最推荐的方式。拿到一个句子发现不好翻，通常就是缺主语，第一反应就是被动句。

看例子：

> 至今已有约 120 个中文词加进了牛津英语词典，成了英语语言的一部分。

这个句子明显缺主语，而且你根本不知道主语是谁，那就被动：
...
以上就是六级翻译的三大必备技巧：修饰后置、多动句、无主句。翻译题所有的句子，基本都逃不出这三个套路。

## 六、翻译方法三步走

技巧讲完了，接下来是方法论。做翻译时，我心里只有一个原则：**先求稳，再去秀。**

什么意思？就是先保证写对，不确定的表达就不要写。我不怕你写得简单，就怕你写错——**写得简单，大部分情况是给分的；写错了，一分都没有。** 六级翻译的评分标准也一直在强调这一点：

- **13~15 分（满分档）**：译文准确表达原文意思，用词贴切，行文流畅，基本无语言错误，仅有个别小错。
- **10~12 分（第 4 档）**：译文基本表达原文意思，文字勉强连贯，但有少量语言错误。

看出来了吗？评分标准翻来覆去都在强调"错误"。所以先求稳、再去秀，只要意思表达清楚，都是有分的。在这个原则下，翻译分三步走：

**第一步：找到句子范围，提炼主干。** 句子的主干无非就是主谓、主谓宾、主系表。拿到一个句子，先把主干提炼出来，原则是：以简单句为主，并列句、名词性从句、定语从句、状语从句为辅。比如"中国许多地方的湖泊和池塘都适宜荷花（lotus）生长"，主干就是"湖泊和池塘适宜生长"，"适宜"是形容词 suitable，be suitable for，所以这是主系表结构：
...
拿"牡丹（Peony）花色艳丽，形象高雅，象征着和平与繁荣"举例，这一句话有四五种写法，全都算对：

1. 拆成两个主干：Peony is colorful and elegant. It symbolizes peace and prosperity.
2. 定语从句（两个版本）：Peony is colorful and elegant, which symbolizes peace and prosperity. / Peony, which is colorful and elegant, symbolizes peace and prosperity.
3. 非谓语动词：Peony is colorful and elegant, symbolizing peace and prosperity.
...
> Bright in color, the lotus blooms in the summer morning and closes at night, with a flowering period of up to two or three months, attracting tourists from all over the world.（版本 2）
...
六级这座山，听力是最大的坎，但它也是最值得投入的坎：技巧帮你把每一分都榨出来，功底帮你把分数上限抬上去。应试技巧就那么多，背熟、练熟、用熟；剩下的时间，老老实实按五步法磨听力，按三步法练翻译，把两套作文模板背到能默写。等上了考场你会发现：它嘚吧嘚它的，你写你的，稳稳的。

祝大家六级一次过，听力 149 起步，上不封顶！
