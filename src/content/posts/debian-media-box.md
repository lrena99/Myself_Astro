...
事情是这样的：Debian 的 logo 和某款药品长得实在太像了，网上一直流传着「Debian 药」的梗，好多人看到那个 swirl 标志，第一反应都是「这不是那盒药吗」。而这个项目干脆把梗变成实物——设计了一个专门用来包装 Debian 安装介质的药盒，平面设计全部开源，下载打印、自己折叠就能用。把社区梗做成实体周边，还免费开源，这操作我真的会谢。梗文化最妙的地方就在这：大家玩着玩着，真有人把梗做成了能用的东西，还开源出来让所有人一起玩。
...
做起来其实不复杂，就两步：打印盒子、打印说明书。先说结论：不用会建模，也不用会设计，图纸人家都画好了，你只管打印、裁剪、折叠。
...
这种把社区梗做成实物还开源的设计，真的太戳我了。作者也很欢迎大家提 issue 和 PR，对包装和说明书有什么改进建议都可以直接去说。而且这套设计不只是「能玩」，是真的能用：装 Debian 安装盘、当小收纳盒、摆桌上当装饰，或者拿去送用 Debian 的朋友，绝对能收获一个会心的笑。感兴趣的话，直接去仓库下载文件打印一个，动手试试就知道了。
